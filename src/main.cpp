...
#if _ShowLightSource
    result = pVAOManager->setInstanceObjVisible("light1", true);
    result = pVAOManager->setInstanceObjVisible("light2", true);
    result = pVAOManager->setInstanceObjVisible("light3", true);
    result = pVAOManager->setInstanceObjVisible("light4", true);
#else
